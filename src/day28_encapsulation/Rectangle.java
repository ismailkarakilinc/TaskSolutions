...
public class Rectangle {
    ...
    public void setWidth(double width) {
        if (width <= 0 ){
            System.err.println("The weidth can not be less than 0");
            System.exit(1);
        }
        this.width = width;
    }
    ...
    public void setLength(double length) {
        if (length <= 0){
            System.err.println("The length can not be less than 0");
            System.exit(1);
        }
        this.length = length;
    }
    ...
    public String toString() {
        return "Rectangle{" +
                "width=" + width +
                ", length=" + length +
                ", Area of the rectangle is = " + calcArea()+
                ", Perimeter of the rectangle is = " + calcPerimeter() +
                '}';
    }
}
/*
